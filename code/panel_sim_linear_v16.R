...
sim<-function(){
  ...
  ##path at laptop
  ##path <-"C:/Users/ezhang2/OneDrive - Seattle University/2024 CSE Summer UG Research Award/R code/sim_linear16/"
  
  ##path at desktop
  path <-"C:/Users/yongl/OneDrive - Seattle University/2024 CSE Summer UG Research Award/R code/sim_linear16/"
